                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                  ...
                                  <form class="form-horizontal" action="{{ url('updateslider')}}" method="post" enctype='multipart/form-data'>
                                        {{ csrf_field() }}
                                        ...
                                        <div class="input-group mb-3">
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input"  id="imgInp" name="slider_image"  value="{{ $data->image }}">
                                        ...
                                        <div class="form-group">
                                        <img id="blah" src="{{ url('slider_img') }}/{{ $data->image }}"
